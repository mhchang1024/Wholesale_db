...
6. Use the following link https://discordapp.com/oauth2/authorize?c&client_id=YOUR_CLIENT_ID_HERE&scope=bot and replace YOUR_CLIENT_ID_HERE in the url with the client id from (5)
